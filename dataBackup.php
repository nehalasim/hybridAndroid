...
$q .= 'INSERT ignore INTO `das`(`CardAvailable`,`Child_ID`, `MPID`, `CPID`, `CC_Code`, `CName`, `MName`, `FName`, `CDOB`,`CAge`, `CSex`,`CHCP`, `Visit_Date`,`Start_Time`, `Q201`, `Q202`, `Q203`, `Q204`, `Q205`, `Q206`, `Q207`, `Q208`, `Q209`, `Q210`, `End_Time`, `Entry_User_ID`,`Entry_Date` ) VALUES("'.$DA1_CARD_clean.'","'.$C_ID_clean.'", "'.$DA1_MPID_clean.'", "'.$DA1_CPID_clean.'",   "'.$CC_NAME_clean.'", "'.$C_NAME_clean.'", "'.$C_M_NAME_clean.'", "'.$C_F_NAME_clean.'", "'.$C_DOB_clean.'", "'.$C_AGE_clean.'", "'.$C_SEX_clean.'", "'.$C_CHP_clean.'", "'.$V_DATE_clean.'", "'.$V_TIME_clean.'", "'.$Q_201_clean.'", "'.$Q_202_clean.'", "'.$Q_203_clean.'", "'.$Q_204_clean.'", "'.$Q_205_clean.'", "'.$Q_206_clean.'", "'.$Q_207_clean.'", "'.$Q_208_clean.'", "'.$Q_209_clean.'", "'.$Q_210_clean.'", "'.$EN_TIME_clean.'", "'.$EN_USER_clean.'", "'.$EN_DATE_clean.'");';
}
 }
